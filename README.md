...
----------------------------------------
Permite adicionar, listar, concluir, remover e salvar tarefas.
As tarefas ficam gravadas em um arquivo JSON (tarefas.json) para
não serem perdidas ao fechar o programa.
"""
...
def concluir_tarefa(tarefas):
    ...
    if not tarefas:
        return
    try:
        numero = int(input("Número da tarefa para marcar como concluída: "))
